...
export const translations = {
  fr: {
    ...
    admin: {
      ...
      subtitle: "Gérez les produits et les catégories de la boutique",
      accessDenied: "Accès refusé",
      accessDeniedText: "Cette page est réservée aux administrateurs.",
      backHome: "Retour à l'accueil",
      ...
      newCategory: "Nom de la nouvelle catégorie",
      add: "Ajouter",
      articles: "article(s)",
    },
  },
  en: {
    ...
    admin: {
      title: "Administration",
      subtitle: "Manage the shop's products and categories",
      accessDenied: "Access denied",
      accessDeniedText: "This page is reserved for administrators.",
      backHome: "Back to home",
      ...
      categoryInUse: "Cannot delete: products are using this category",
  ...
  mg: {
    ...
    orders: {
      title: "Ny fividianako",
      subtitle: "Jereo ny tantaran'ny fividiananao",
      empty: "Mbola tsy nanao fividianana ianao.",
      view: "Jereo ny faktiora",
      orderNumber: "N° fividianana",
      date: "Daty",
      articles: "entana",
      paid: "Voaloa",
      backToShop: "Hiverina amin'ny fivarotana",
    ...
    admin: {
      title: "Fitantanana",
      subtitle: "Tantano ny vokatra sy ny sokajin'ny fivarotana",
      accessDenied: "Tsy azo idirana",
      accessDeniedText: "Ho an'ny mpitantana ihany ity pejy ity.",
      backHome: "Hiverina amin'ny fandraisana",
      productsTab: "Vokatra",
      categoriesTab: "Sokajy",
      addProduct: "Manampy vokatra",
      editProduct: "Manova vokatra",
      name: "Anarana",
      category: "Sokajy",
      price: "Vidiny",
      stock: "Tahiry",
      ...
      edit: "Hanova",
      delete: "Hamafa",
      saved: "Voatahiry soa aman-tsara",
      deleted: "Voafafa soa aman-tsara",
      confirmDelete: "Tena hamafa ity zavatra ity ve ianao?",
      categoryInUse: "Tsy azo fafana: misy vokatra mampiasa ity sokajy ity",
      newCategory: "Anaran'ny sokajy vaovao",
      add: "Manampy",
      articles: "entana",
    },
  },
